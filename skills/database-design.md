...
type: architecture
purpose: Design data models, relationships, indexes, constraints, migrations, and integrity rules.
when_to_use: Use when design data models, relationships, indexes, constraints, migrations, and integrity rules.
...
Design data models, relationships, indexes, constraints, migrations, and integrity rules.
