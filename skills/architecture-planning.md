...
type: architecture
purpose: Provide reusable architecture planning workflow guidance for the starter kit.
when_to_use: Use when provide reusable architecture planning workflow guidance for the starter kit.
...
Provide reusable architecture planning workflow guidance for the starter kit.
