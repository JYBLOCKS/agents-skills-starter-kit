...
name: docs-sync
type: workflow
purpose: Provide reusable docs sync workflow guidance for the starter kit.
when_to_use: Use when provide reusable docs sync workflow guidance for the starter kit.
...
Provide reusable docs sync workflow guidance for the starter kit.
