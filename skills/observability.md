...
name: observability
type: workflow
purpose: Define logging, metrics, tracing, health checks, and runtime signals.
when_to_use: Use when define logging, metrics, tracing, health checks, and runtime signals.
...
Define logging, metrics, tracing, health checks, and runtime signals.
