...
name: release-notes
type: workflow
purpose: Provide reusable release notes workflow guidance for the starter kit.
when_to_use: Use when provide reusable release notes workflow guidance for the starter kit.
...
Provide reusable release notes workflow guidance for the starter kit.
