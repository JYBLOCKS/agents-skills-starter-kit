...
type: architecture
purpose: Define design system foundations, components, interaction states, and accessibility rules.
when_to_use: Use when define design system foundations, components, interaction states, and accessibility rules.
...
Define design system foundations, components, interaction states, and accessibility rules.
