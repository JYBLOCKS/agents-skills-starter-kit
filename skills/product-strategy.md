...
type: workflow
purpose: Define product vision, users, MVP, roadmap, stories, and acceptance criteria.
when_to_use: Use when define product vision, users, mvp, roadmap, stories, and acceptance criteria.
...
Define product vision, users, MVP, roadmap, stories, and acceptance criteria.
