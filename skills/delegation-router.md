...
type: workflow
purpose: Route work to the smallest correct set of agents and skills.
when_to_use: Use when route work to the smallest correct set of agents and skills.
...
Route work to the smallest correct set of agents and skills.
