...
type: architecture
purpose: Design backend layers, service boundaries, validation flow, errors, and contracts.
when_to_use: Use when design backend layers, service boundaries, validation flow, errors, and contracts.
...
Design backend layers, service boundaries, validation flow, errors, and contracts.
