...
name: ux-research
type: workflow
purpose: Identify user needs, friction, flow gaps, scenarios, and UX criteria.
when_to_use: Use when identify user needs, friction, flow gaps, scenarios, and ux criteria.
...
Identify user needs, friction, flow gaps, scenarios, and UX criteria.
