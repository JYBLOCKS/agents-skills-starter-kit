...
type: workflow
purpose: Convert vague requests into clear goals, scope, constraints, and acceptance criteria.
when_to_use: Use when convert vague requests into clear goals, scope, constraints, and acceptance criteria.
token_saving_level: high
---
...
Convert vague requests into clear goals, scope, constraints, and acceptance criteria.
