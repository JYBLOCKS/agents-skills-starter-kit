...
name: devops-ci-cd
type: workflow
purpose: Define build, CI, release, deploy, environment, and operational readiness flow.
when_to_use: Use when define build, ci, release, deploy, environment, and operational readiness flow.
...
Define build, CI, release, deploy, environment, and operational readiness flow.
