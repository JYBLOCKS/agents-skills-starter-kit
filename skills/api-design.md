...
name: api-design
type: architecture
purpose: Design clear API contracts, payloads, validation, errors, auth, and compatibility.
when_to_use: Use when design clear api contracts, payloads, validation, errors, auth, and compatibility.
...
Design clear API contracts, payloads, validation, errors, auth, and compatibility.
