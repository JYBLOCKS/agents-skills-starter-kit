...
name: documentation
type: workflow
purpose: Write concise docs for usage, architecture, tests, deploy, and maintenance.
when_to_use: Use when write concise docs for usage, architecture, tests, deploy, and maintenance.
...
Write concise docs for usage, architecture, tests, deploy, and maintenance.
