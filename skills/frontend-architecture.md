...
type: architecture
purpose: Design maintainable frontend structure, state boundaries, reusable components, and test seams.
when_to_use: Use when design maintainable frontend structure, state boundaries, reusable components, and test seams.
...
Design maintainable frontend structure, state boundaries, reusable components, and test seams.
