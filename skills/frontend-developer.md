...
type: workflow
purpose: Provide reusable frontend developer workflow guidance for the starter kit.
when_to_use: Use when provide reusable frontend developer workflow guidance for the starter kit.
...
Provide reusable frontend developer workflow guidance for the starter kit.
