...
type: workflow
purpose: Provide reusable adapter generation workflow guidance for the starter kit.
when_to_use: Use when provide reusable adapter generation workflow guidance for the starter kit.
...
Provide reusable adapter generation workflow guidance for the starter kit.
