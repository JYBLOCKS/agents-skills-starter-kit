...
name: repo-analysis
type: workflow
purpose: Provide reusable repo analysis workflow guidance for the starter kit.
when_to_use: Use when provide reusable repo analysis workflow guidance for the starter kit.
...
Provide reusable repo analysis workflow guidance for the starter kit.
