...
name: code-review
type: workflow
purpose: Review code for correctness, regressions, architecture, duplication, tests, and security gaps.
when_to_use: Use when review code for correctness, regressions, architecture, duplication, tests, and security gaps.
...
Review code for correctness, regressions, architecture, duplication, tests, and security gaps.
