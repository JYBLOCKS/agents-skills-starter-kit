...
name: creator-intake
type: workflow
purpose: Provide reusable creator intake workflow guidance for the starter kit.
when_to_use: Use when provide reusable creator intake workflow guidance for the starter kit.
...
Provide reusable creator intake workflow guidance for the starter kit.
