...
type: quality
purpose: Scale tests to risk and map validation to acceptance criteria.
when_to_use: Use when scale tests to risk and map validation to acceptance criteria.
...
Scale tests to risk and map validation to acceptance criteria.
