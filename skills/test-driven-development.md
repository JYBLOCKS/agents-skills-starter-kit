...
type: quality
purpose: Define and execute tests before or during implementation so completion depends on passing validation.
when_to_use: Use when define and execute tests before or during implementation so completion depends on passing validation.
...
Define and execute tests before or during implementation so completion depends on passing validation.
