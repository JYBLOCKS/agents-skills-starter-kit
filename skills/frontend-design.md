...
type: architecture
purpose: Provide reusable frontend design workflow guidance for the starter kit.
when_to_use: Use when provide reusable frontend design workflow guidance for the starter kit.
...
Provide reusable frontend design workflow guidance for the starter kit.
