...
type: workflow
purpose: Provide reusable requirements extraction workflow guidance for the starter kit.
when_to_use: Use when provide reusable requirements extraction workflow guidance for the starter kit.
...
Provide reusable requirements extraction workflow guidance for the starter kit.
