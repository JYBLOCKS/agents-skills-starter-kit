...
description: Role definition and operating contract for optional runbook-creator-agent.
...
- Skills: `optional/skills/creator-intake`, `optional/skills/runbook-creation`, `optional/skills/creator-validation`
- Specs: `optional/creators/questionnaires/runbook.yaml`

## Runbooks and Checklists

- Runbook: `runbooks/create-with-creators.md`
- Checklist: `optional/agents/runbook-creator-agent/checklist.md`
