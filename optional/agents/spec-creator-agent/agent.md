...
description: Role definition and operating contract for optional spec-creator-agent.
...
- Skills: `optional/skills/creator-intake`, `optional/skills/spec-creation`, `optional/skills/creator-validation`
- Specs: `specs/CONTRACT.md`, `optional/creators/questionnaires/spec.yaml`

## Runbooks and Checklists

- Runbook: `runbooks/create-with-creators.md`
- Checklist: `optional/agents/spec-creator-agent/checklist.md`
