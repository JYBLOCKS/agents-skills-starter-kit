...
description: Role definition and operating contract for optional rule-creator-agent.
...
- Skills: `optional/skills/creator-intake`, `optional/skills/rule-creation`, `optional/skills/creator-validation`
- Specs: `optional/creators/questionnaires/rule.yaml`, `rules/README.md`

## Runbooks and Checklists

- Runbook: `runbooks/create-with-creators.md`
- Checklist: `optional/agents/rule-creator-agent/checklist.md`
