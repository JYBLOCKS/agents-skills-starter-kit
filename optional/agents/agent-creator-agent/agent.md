...
description: Role definition and operating contract for optional agent-creator-agent.
...
- Skills: `optional/skills/creator-intake`, `optional/skills/agent-creation`, `optional/skills/creator-validation`
- Specs: `agents/CONTRACT.md`, `optional/creators/questionnaires/agent.yaml`

## Runbooks and Checklists

- Runbook: `runbooks/create-with-creators.md`
- Checklist: `optional/agents/agent-creator-agent/checklist.md`
