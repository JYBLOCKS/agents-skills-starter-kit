---
name: adapter-creator-agent-handoff-template
description: Standard downstream handoff template for optional adapter-creator-agent.
trigger: Use this when adapter-creator-agent needs to hand work to another agent in the standard repository format.
metadata:
  author: starter-kit
  version: 0.3.0
