...
role: Spec Agent
seniority: senior
main_goal: Own the spec agent workflow and produce contract-compliant handoffs for the starter kit.
when_to_use: Use when work needs spec agent ownership.
delegates_to: []
uses_skills:
  - spec-writing.md
  - repo-analysis.md
...
Own the spec agent workflow and produce contract-compliant handoffs for the starter kit.
