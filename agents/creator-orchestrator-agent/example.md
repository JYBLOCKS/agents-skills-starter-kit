...
The agent identifies `adapter-creator-agent`, points it to `creators/questionnaires/adapter.yaml`, and notes that a README update may also require `docs-agent`.
