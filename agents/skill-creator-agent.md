...
seniority: senior
main_goal: Own the skill creator agent workflow and produce contract-compliant handoffs for the starter kit.
when_to_use: Use when work needs skill creator agent ownership.
delegates_to: []
uses_skills:
  - creator-intake.md
...
Own the skill creator agent workflow and produce contract-compliant handoffs for the starter kit.
