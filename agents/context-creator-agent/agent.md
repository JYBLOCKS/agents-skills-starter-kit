...
trigger: Use this when the task matches the mission and decision boundaries of context-creator-agent
metadata:
  author: starter-kit
  version: 0.3.0
  scope: Owns mission and decision boundaries for context-creator-agent; complements shared rules, context, and approved specs
  auto-invoke: false
