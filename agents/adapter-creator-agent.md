...
role: Adapter Creator Agent
seniority: senior
main_goal: Own the adapter creator agent workflow and produce contract-compliant handoffs for the starter kit.
when_to_use: Use when work needs adapter creator agent ownership.
delegates_to: []
uses_skills:
  - creator-intake.md
...
# Agent: Adapter Creator Agent

## Purpose

Own the adapter creator agent workflow and produce contract-compliant handoffs for the starter kit.
