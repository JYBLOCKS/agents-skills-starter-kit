...
seniority: senior
main_goal: Own the agent creator agent workflow and produce contract-compliant handoffs for the starter kit.
when_to_use: Use when work needs agent creator agent ownership.
delegates_to: []
uses_skills:
  - creator-intake.md
...
Own the agent creator agent workflow and produce contract-compliant handoffs for the starter kit.
