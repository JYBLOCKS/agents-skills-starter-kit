...
seniority: senior
main_goal: Own the implementation agent workflow and produce contract-compliant handoffs for the starter kit.
when_to_use: Use when work needs implementation agent ownership.
delegates_to: []
uses_skills:
  - repo-analysis.md
  - task-breakdown.md
...
Own the implementation agent workflow and produce contract-compliant handoffs for the starter kit.
