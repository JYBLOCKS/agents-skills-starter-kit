...
description: Starter prompt for adapter-creator-agent.trigger: Use this when you need the starter prompt that anchors adapter-creator-agent in a host tool.
