...
seniority: senior
main_goal: Own the checklist creator agent workflow and produce contract-compliant handoffs for the starter kit.
when_to_use: Use when work needs checklist creator agent ownership.
delegates_to: []
uses_skills:
  - creator-intake.md
...
# Agent: Checklist Creator Agent

## Purpose

Own the checklist creator agent workflow and produce contract-compliant handoffs for the starter kit.
